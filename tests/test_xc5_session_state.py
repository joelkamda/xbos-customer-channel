...
class CR1SessionSecurityTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.entry = ResolvedEntryContext(
            token_ref="ent_secure_fixture_1",
    ...
    def test_cr1_c06_two_concurrent_resumes_exactly_one_rotation(self) -> None:
        ...
        with ThreadPoolExecutor(max_workers=2) as pool:
            results = list(pool.map(lambda _: resume_once(), range(2)))
    ...
    def test_cr1_c09_rotation_preserves_context_fingerprint(self) -> None:
        ...
        after = (
            rotated.owner_identity_ref,
            rotated.tenant_ref,
            rotated.merchant_ref,
            rotated.location_ref,
            rotated.table_ref,
            rotated.dining_area_ref,
            rotated.entry_purpose,
            rotated.context_binding_ref,
            rotated.correlation_ref,
            rotated.entry_token_ref,
        )
        self.assertEqual(before, after)
        self.assertNotEqual(session.session_ref, rotated.session_ref)
